...
import { addProductData } from "../../services/productService";
...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await addProductData(product);
      ...
      if (response.status === "success") {
        ...
        setError(response.message || "There was an error adding the product.");
        setName("");
        setDescription("");
        setPrice("");
        setSizes([]); 
